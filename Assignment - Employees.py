...
application_id = dbutils.secrets.get(scope="databricks-keyvault-123",key="application-id")
tenant_id = dbutils.secrets.get(scope="databricks-keyvault-123",key="tenant-id")
...
dbutils.fs.mount(
  source = "abfss://employees@datalakejmdtest.dfs.core.windows.net/",
